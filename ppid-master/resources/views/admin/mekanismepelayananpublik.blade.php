...
<head>
  ...
  <title>Mekanisme Pelayanan Publik</title>
...
<body class="bg-gray-100">
    ...
    <h1 class="text-3xl text-white font-bold mb-4 pt-4 text-center h-20 bg-gradient-to-r from-[#4477CE] to-[#223C68]">Mekanisme Pelayanan Publik</h1>
    ...
    <!-- Image -->
      <p class="pl-12 pt-4 text-blue-700 mb-6">Formulir Permintaan Informasi</p>

        <div class="bg-white p-8 rounded-lg">
            <div class="flex justify-center items-center">
                <img src="{{ asset('assets/img/foto/tatacara.png')}}" alt="Struktur Kelembagaan PPID" class="w-auto h-96 max-w-4xl mx-auto">
            </div>
        </div>

        <h1 class="pl-12 text-xl pt-20 font-semibold text-black mb-4">MEKANISME PERMINTAAN INFORMASI BAGI DISABILITAS</h1>
        <p class="pl-12 text-blue-700 mb-6">SOP PELAYANAN INFORMASI BAGI PENYANDANG DISABILITAS</p>
        
           <div class="bg-white p-8 shadow-lg rounded-lg">
               <div class="flex justify-center items-center">
                   <img src="{{ asset('assets/img/foto/prosedurpelayanan.png')}}" alt="Struktur Kelembagaan PPID" class="w-auto h-96 max-w-4xl mx-auto">
               </div>
           </div>
    </main>
