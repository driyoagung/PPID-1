...
<head>
  ...
  <title>Bagan Organisasi PPID</title>
...
<body class="bg-gray-100">
    ...
    <h1 class="text-3xl text-white font-bold mb-4 pt-4 text-center h-20 bg-gradient-to-r from-[#4477CE] to-[#223C68]">Bagan Organisasi PPID</h1>
    <nav class="w-full rounded-md">
        ...
        <div class="bg-white p-8 shadow-lg rounded-lg">
            <div class="flex justify-center items-center">
                <img src="{{ asset('assets/img/foto/strukturlembagappid.png')}}" alt="Struktur Kelembagaan PPID" class="w-auto h-96 max-w-4xl mx-auto">
            </div>
        </div>
    </main>
